...
img_original = cv2.imread('image/Character_segmentation_image/09削顶.jpg')  # 读取图片
...
# 查找轮廓
contours, hierarchy = cv2.findContours(image, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)  # cv2.RETR_EXTERNAL 定义只检测外围轮廓
words = []
word_images = []
